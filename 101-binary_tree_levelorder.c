...
/**
 * linked_node - funct that makes a linked list from depth level and node
...
/**
 * binary_tree_levelorder - printing the node element in a lever-order
 * @tree: root node
 * @func: funct to use
 * Return: nothin
 */
