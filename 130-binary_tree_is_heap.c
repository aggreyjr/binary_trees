...
/**
 * binary_tree_height - funct that measures the height of a binary tree
 * @tree: tree used
 * Return: height
 */
...
/**
 * binary_tree_balance - Measuring balance factor of a binary tree
 * @tree: tree used
...
/**
 * tree_is_perfect - funct that determines if a tree is perfect or not
 ...
 * @tree: tree used
 * Return: 1 if it is  valid or 0 if not
 */
