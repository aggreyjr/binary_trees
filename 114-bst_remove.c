...
/**
 * successor - get the next successor min node in the right subtree
 * @node: tree used
...
/**
 *remove_type - funct that removes a node depending on its children
 *@root: node to remove
 *Return: 0 if it has no children or other values
 */
